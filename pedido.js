...
function makePurchase() {
  var nom = document.getElementById("cNome").value;
  var end = document.getElementById("cRua").value;
  var est = document.getElementById("cEst").value;
  var cid = document.getElementById("cCid").value;
  var num= document.getElementById("cNum").value;
  var com= document.getElementById("cCom").value;
